 ...
 *  @generated
 */
package com.meituan.thriftserver.interfaces;
...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.3)", date = "2023-08-24")
public class Student implements org.apache.thrift.TBase<Student, Student._Fields>, java.io.Serializable, Cloneable, Comparable<Student> {
  ...
  private static final _Fields optionals[] = {_Fields.NAME,_Fields.AGE,_Fields.SEX,_Fields.ADDRESS};
